...
// console.log multiple time , manually, then via function
// show calculation total, take price, tax. add them, get total
// then create a function to fo that .
...
// say hello function, without parameters

// say hello with parameters.

// greeting with default paamaters.

const greeting = function (name = "Dear User", partOfDay = "Morning") {
  return `Good ${partOfDay}, ${name}`;
};

// console.log(greeting("morning", "Ahmad"))
// console.log(greeting())
// console.log(greeting("Ali", "evening"))

// function declaredFun () {
//     console.log(`i am declared funciton, i can  hoist`)
// }

// const expressedFun = function (){
//     console.log("`i am expressed fun, i cannot hoist")
// }
...
/*
    ...
    - Expression is NOT hoisted (must define before calling)
*/

// multiply function, add function, divide function.
// show difference between declared function and expressed function,
...
// show difference between console.log and return values
...
// guard clause
// pure function, no side efects, and no external change
// factory function, that create objects.

// create user function, that create user object, and return it, with greeting method.
// then call that greeting method

// prime finder
// only divid by 1 or themself. no other number can full divide them.
